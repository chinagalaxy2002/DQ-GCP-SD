"""Parameter-tied all-interlayer DQ-CGP experiment for Sim-DETR.
...
::
    ...
    Decoder Layer 3
         │
         ▼
    DQ-CGP (same parameters reused again)
         │
         ▼
    Decoder Layer 4
         │
...
From a training script::
    ...
    from sim_detr.dq_cgp.tied_all_stage.model_builder import (
...
Or directly::
    ...
    from sim_detr.dq_cgp.tied_all_stage import (
        SimDETRWithTiedAllStageDQCGP, DETRQueryCGP,
    )
"""
...
from .sim_detr_dq_cgp import ARCHITECTURE_ID, SimDETRWithTiedAllStageDQCGP
