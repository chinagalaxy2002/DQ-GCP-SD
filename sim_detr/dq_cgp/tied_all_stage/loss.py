...
def loss_query_cgp(
    ...
    """Average the three depth-specific V3 losses for the tied module.
    ...
    middle_bind, middle_route = _stage_query_cgp_losses(
        temporal_attention=outputs["query_cgp_middle_temporal_attention"],
        basis_weights=outputs["query_cgp_middle_basis_weights"],
        video_mask=video_mask,
        targets=targets,
        indices=indices,
        span_loss_type=span_loss_type,
    ...
    binding_loss = (early_bind + middle_bind + late_bind) / 3.0
    route_loss = (early_route + middle_route + late_route) / 3.0
    ...
    return {
        ...
        "query_cgp_middle_bind_raw": middle_bind.detach(),
        "query_cgp_late_bind_raw": late_bind.detach(),
        "query_cgp_early_route_raw": early_route.detach(),
        "query_cgp_middle_route_raw": middle_route.detach(),
