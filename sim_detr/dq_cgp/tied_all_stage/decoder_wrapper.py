"""State-dict-preserving tied all-interlayer DQ-CGP hook for Sim-DETR.
...
The same registered DQ-CGP module refines content after decoder layers 1, 2
and 3 (0-indexed layers 0, 1 and 2). The hook snapshots diagnostics immediately
after each call so later calls cannot overwrite earlier training signals.
"""
