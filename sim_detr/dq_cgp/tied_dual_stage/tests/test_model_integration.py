...
from sim_detr.dq_cgp.tied_dual_stage.decoder_wrapper import (
    get_dq_cgp_stage_outputs,
)
from sim_detr.dq_cgp.tied_dual_stage.sim_detr_dq_cgp import (
    SimDETRWithTiedDualDQCGP,
)
from sim_detr.dq_cgp.tied_dual_stage.utils import masked_mean_pool
...
class TestSemanticMask:
    def test_model_exposes_both_preserved_stage_snapshots(self):
