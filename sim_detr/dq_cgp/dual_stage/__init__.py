"""Dual-stage DQ-CGP experiment for Sim-DETR.
...
::
    ...
    Decoder Layer 2 → 3
         │
         ▼
    DQ-CGP (independent late parameters)
         │
         ▼
    Decoder Layer 4
         │
...
From a training script::
    ...
    from sim_detr.dq_cgp.dual_stage.model_builder import (
...
Or directly::
    ...
    from sim_detr.dq_cgp.dual_stage import SimDETRWithDualDQCGP, DETRQueryCGP
"""
