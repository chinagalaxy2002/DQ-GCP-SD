...
from sim_detr.start_end_dataset import StartEndDataset, start_end_collate, prepare_batch_inputs
...
if __name__ == '__main__':
    ...
    _p.add_argument("--eval_split_name", type=str, default=None)
    _p.add_argument("--eval_path", type=str, default=None)
    _known, _ = _p.parse_known_args()
    start_inference(split=_known.eval_split_name, splitfile=_known.eval_path)
