...
The checkpoint is uploaded as two lossless Release assets because the local
upload path rejects the original 155 MB single file. Reconstruct and verify it
